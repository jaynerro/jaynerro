    ...
    <?php // Mise en place d'un fil d'Arianne ?>
      ...
      <div class="row justify-content-center" style="margin-top: 10px;">
        <div class="group col-sm-8">  
          ...
          <img src="../../../../images/mesh-network-topology.png" class="img-fluid float-left" style="max-width: 40.6%; margin-left: 15%; margin-top: 1em;"/>
        </div>
      </div>
      ...
      <div class="row justify-content-center">
        <div class="group col-sm-8">
          ...
          <p style="margin-top: 40px;">
            ...
            Le modèle OSI est né en 1984. Celui-ci est né après la naissance d'Internet. </br></br>
