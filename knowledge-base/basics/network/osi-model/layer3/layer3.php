...
<html lang="fr">
  ...
  <head>
    ...
    <title>Modèle OSI - Couche 3 : La couche Réseau et le protocole IP</title>
  </head>
                ...
                <div class="breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">La couche Réseau et le protocole IP</li>
                        </ol>
                    </nav>
                </div> 
            </div>
