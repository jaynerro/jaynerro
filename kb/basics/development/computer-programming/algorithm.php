...
<html lang="fr">
  ...
  <head>
    ...
    <title>La programmation informatique - L'algorithme</title>
                ...
                <div class="breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">L'algorithme</li>
                        </ol>
                    </nav>
                </div> 
            </div>
        ...
        <div class="row justify-content-center">
            <div class="col-sm-8">
                ...
                <p style="margin-top: 30px;"> 
                    L'algorithme est indispensable dans la programmation. Un algorithme est un ensemble d'instructions à suivre pour aboutir à un résultat.</br></br>
